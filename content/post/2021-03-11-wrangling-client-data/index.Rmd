...
Now that the data is tidy and ready to go, I can use it to make [visuals](https://aubreyshuga.netlify.app/post/exploratory-visuals/) or run [hypothesis tests](). Wrangling can be a big part of any data science project (sometimes even the biggest part!), but it is so necessary for the rest of the project to go smoothly.
